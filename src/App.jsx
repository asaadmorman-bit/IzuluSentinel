...
import AssetSentinelDashboard from './pages/AssetSentinelDashboard';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/SituationalAwareness" element={<LayoutWrapper currentPageName="SituationalAwareness"><SituationalAwareness /></LayoutWrapper>} />
      <Route path="/AssetSentinelDashboard" element={<LayoutWrapper currentPageName="AssetSentinelDashboard"><AssetSentinelDashboard /></LayoutWrapper>} />
